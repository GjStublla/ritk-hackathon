        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <p class="mb-4">We're dedicated to delivering innovative solutions that empower businesses to thrive
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <form class="mb-4">
                        <div class="input-group">
                            <input type="email" class="form-control newsletter-input text-white"
